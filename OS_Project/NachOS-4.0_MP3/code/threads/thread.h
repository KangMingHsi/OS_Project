...
class Thread {
  ...
  public:
    ...
    void setExecPriority(int t){execPriority = t;}
    int getExecPriority(){return execPriority;}

    void setLastCheckInQueueTime(int t){lastCheckInQueueTime = t;}
    int getLastCheckInQueueTime(){return lastCheckInQueueTime;}
